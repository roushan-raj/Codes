import java.util.*;
public class Q2a_Method1_MostOptimal_Day21 {
	...
	public void getKthSmallestElement(TreeNode root, int pos) {
		if(root == null)
			return;
	...
	public static void main(String[] args) {
		...
		Q2a_Method1_MostOptimal_Day21 ob = new Q2a_Method1_MostOptimal_Day21();
		...
		ob.getKthSmallestElement(root, 6);
	}
}
